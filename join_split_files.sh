...
cat product/app/WallpaperPicker_fcn/WallpaperPicker_fcn.apk.* 2>/dev/null >> product/app/WallpaperPicker_fcn/WallpaperPicker_fcn.apk
rm -f product/app/WallpaperPicker_fcn/WallpaperPicker_fcn.apk.* 2>/dev/null
