...
DEVICE_PATH := device/hmd/FCN_sprout
...
TARGET_KERNEL_CONFIG := FCN_sprout_defconfig
TARGET_KERNEL_SOURCE := kernel/hmd/FCN_sprout
...
include vendor/hmd/FCN_sprout/BoardConfigVendor.mk
